...
//        string Dataseat = "treesurveyv3";
        ...
        Movie[] movies = JsonReader.Deserialize<Movie[]>(jsonResponse);
        ...
        foreach (Movie movie in movies)
        {
            ...
            Debug.Log("This products name is: " + movie.MovieID);
            ...
            newCube.GetComponentInChildren<TextMesh>().text = movie.MovieID;
        }
	}
